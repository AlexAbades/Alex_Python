...
def who_starts():
    start = False
    while not start:
        print('Hello, I am going to be your opponent...')
        print('I am CPU...')
        print('Nice to meet you!')
        first_choice = input("So, are you a pussy? \n"
                             "CPU Starts --> 1\n"
                             "Player starts --> 2\n"
...
def cpu_first():
    global prob_center, center, count_move, is_edges, is_corner, win, comb_corner_no_center
    corner = 'a1 a3 c1 c3'.split()
    edge = {
        'b1': ['a3', 'c3'],
        'b3': ['a1', 'c1'],
    ...
    if not center and comb_corner_no_center: #  and p_k['b2'] == ' '
        # The CPI starts in the corner
...
######## PROBLEMS
# en la tercera iteración el panel no resetea
# Start in corner, if instead of block the winner combination the user move in another location it doesn't do anything
...
def check_movements():
    global p_k, d
    # Dictionary to Probe to check if there are still movements to do
    finish_movements = {
        'a1': ' ',
        'a2': ' ',
        'a3': ' ',
    ...
    for element in check:
        if check[element] == 'X':
            finish_movements[element] = 'finish'
        elif check[element] == 'O':
            finish_movements[element] = 'finish'
        else:
            pass
    return finish_movements
"""
"""
...
def cpu_fisrt():
    ...
    corner1 = 'a1 c3'.split()
    corner2 = 'c1 a3'.split()
    corners = 'a1 a3 c1 c3'.split()
    while count_move == 0:
        p_k[corners[randint(0,3)]] = 'O'
        count_move += 1
        return
    while count_move == 1:
        if p_k['b2'] != 'X':
